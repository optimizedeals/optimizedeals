...
function CaseStudyCard({ study, index }: { study: typeof caseStudies[0]; index: number }) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
    >
      <div className="relative h-full p-8 bg-gradient-to-b from-card/60 to-card/30 border border-border/50 rounded-2xl backdrop-blur-sm overflow-hidden transition-all duration-500 hover:border-primary/50">
        {/* Background gradient */}
        ...
        <div className="space-y-4 mb-6">
          <div>
            <h4 className="text-xs font-mono text-brand-gray uppercase tracking-wider mb-2">Challenge</h4>
            <p className="text-sm text-muted-foreground leading-relaxed">{study.problem}</p>
          </div>
          <div>
            <h4 className="text-xs font-mono text-brand-gray uppercase tracking-wider mb-2">Solution</h4>
