...
const services = [
  {
    ...
    description:
      "Scalable React ecosystems, enterprise frontend systems, modular architecture, and performance engineering.",
  ...
  },
  {
    ...
    description:
      "Runtime composition, federated systems, independent deployments, and multi-team scalability.",
  ...
  },
  {
    ...
    description:
      "Nx, Turborepo, shared tooling, CI acceleration, and developer experience optimization.",
  ...
  },
  {
    ...
    description:
      "AI-native experiences, RAG systems, OpenAI integrations, intelligent workflows, and contextual systems.",
  ...
  },
  {
    ...
    description:
      "Legacy migration, architecture recovery, frontend restructuring, and scalability planning.",
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            Specialized services focused on frontend architecture, platform
            engineering, and modern product development.
          </p>
        </motion.div>
