...
import { calculateTitleFontSize, calculateLineHeight, truncateText, formatCategory } from './utils'
 ...
 */
export function OGDescription({ children, maxLength = 150, maxWidth }: DescriptionProps) {
