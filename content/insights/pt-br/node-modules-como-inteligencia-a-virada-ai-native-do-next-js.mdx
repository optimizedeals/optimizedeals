...
>
  ...
  atualizados. Um arquivo `AGENTS.md` na raiz do seu projeto direciona os agentes
  para essas docs empacotadas em vez de seus dados de treino.
</QuoteBlock>
...
<MetricsCard
  ...
  metrics={[
    ...
    { label: "Manifesto default de agente em novos projetos", value: "AGENTS.md" },
  ]}
/>
...
<ComparisonTable
  ...
  rows={[
    ...
    },
    {
      ...
      values: ["Alucinações confiantes", "Contexto local desatualizado ou ausente"],
    },
  ]}
/>
