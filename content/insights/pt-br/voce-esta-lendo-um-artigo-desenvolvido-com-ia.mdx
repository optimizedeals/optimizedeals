...
<ArchitectureDiagram
  title="Camadas de infraestrutura de SEO"
  description="Cada rota de conteúdo gera seus próprios metadados, dados estruturados e referências de localização em runtime."
