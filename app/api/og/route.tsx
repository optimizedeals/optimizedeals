...
import { OGBackground, OGBackgroundArticle } from '@/lib/og/background'
import { OGLogo } from '@/lib/og/logo'
import { OGTitle, OGDescription, OGCategoryBadge, OGPageBadge } from '@/lib/og/typography'

export const runtime = 'edge'

// Page metadata configuration
const PAGE_META: Record<string, { title: string; description: string; badge?: string; pageType: PageType }> = {
  '': {
    title: 'Frontend Architecture & Platform Engineering Studio',
    description: 'We build high-performance React and AI-powered platforms focused on scalability, architecture and execution speed.',
    pageType: 'homepage',
  },
  'solutions': {
  ...
  'book': {
    ...
    description: 'Let\'s discuss your engineering challenges and explore how we can help.',
    badge: 'Schedule',
    pageType: 'default',
  },
}
...
export async function GET(request: NextRequest) {
  ...
  const isArticle = articleTitle || (path.startsWith('insights/') && path !== 'insights')
  ...
  const imageContent = pageType === 'article' 
...
function renderArticleOG(title: string, description?: string, category?: string) {
  return (
    <div
      style={{
        width: OG_CONFIG.width,
